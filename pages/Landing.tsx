...
import { 
  ...
  Palette, MessageSquare, Database, Settings, ChevronDown
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full relative overflow-x-hidden bg-[#010309] selection:bg-blue-600/30">
      ...
      <nav className="relative z-50 p-6 lg:px-16 flex items-center justify-between">
        <div className="flex items-center gap-4 bg-[#020617]/90 backdrop-blur-3xl px-6 py-4 rounded-2xl border border-white/10 shadow-2xl">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center shadow-[0_0_30px_rgba(59,130,246,0.5)]">
            <Logo className="text-white w-7 h-7" />
          </div>
          <div>
            <h1 className="text-[16px] font-black text-white tracking-tight leading-none">NEXUS AI</h1>
            <span className="text-[10px] text-blue-400 font-bold uppercase tracking-[0.25em]">Create Everything</span>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`text-center transition-all duration-100 ${glitch ? 'skew-x-1 translate-x-1' : ''}`}>
            <h2 className="text-6xl md:text-8xl lg:text-[10rem] font-black tracking-tighter uppercase leading-[0.85] mb-8">
              ...
              <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_0_80px_rgba(59,130,246,0.4)] animate-gradient">
                Everything
              </span>
            </h2>
            
            <p className="text-lg md:text-2xl text-slate-300 font-medium max-w-4xl mx-auto leading-relaxed mb-12">
              Build AI agents, generate images, create videos, forge apps, design games — 
              <span className="text-white font-bold"> all powered by the world's most advanced AI models.</span>
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-white font-black">NEXUS AI</h4>
                <p className="text-[10px] text-slate-500 uppercase tracking-widest">The Everything Platform</p>
              </div>
            </div>
